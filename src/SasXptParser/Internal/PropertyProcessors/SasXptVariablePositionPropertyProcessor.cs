...
namespace SasXptParser.Internal
{
    ...
    /// </summary>
    internal class SasXptVariablePositionPropertyProcessor : SasXptVariablePropertyProcessor
    {
        /// <summary>
        ...
        public override object ProcessProperty(string propertyName, ISasXptByteProcessor byteProcessor, byte[] bytes)
        {
            ...
            var positionByteSubset = byteProcessor.GetSubsetFromByteArray(bytes, parsingPair.SkipCount, parsingPair.ReadableCount);
            return byteProcessor.ConvertToBigEndian(byteProcessor.ConvertBytesToInt(positionByteSubset));
        }
    }
}